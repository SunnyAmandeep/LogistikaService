...
namespace Logistika.Service.Providers
{
    public class SimpleAuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override Task ValidateClientAuthentication(OAuthValidateClientAuthenticationContext context)
        {
            ...
            Logistika.Service.Common.Entities.Authentication.Client client = null;
            ...
            {
                client = new Logistika.Service.Common.Entities.Authentication.Client
                {
                    Id = "LogistikaApp",
                    Secret = HashHelper.GetHash("abc@123rdes"),
                    Name = "LogistikaApp front-end Application",
        ...
        {
            var allowedPaths = new List<string> { "/token", "/api/RefreshTokens" };
