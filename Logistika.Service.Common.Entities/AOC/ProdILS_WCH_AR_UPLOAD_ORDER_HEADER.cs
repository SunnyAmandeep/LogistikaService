...
namespace Logistika.Service.Common.Entities.AOC
{
    ...
    public partial class ProdILS_WCH_AR_UPLOAD_ORDER_HEADER
    {
        ...
        public Nullable<decimal> CONTAINERS_SHIPPED { get; set; }
        public Nullable<decimal> WEIGHT_SHIPPED { get; set; }
        public Nullable<decimal> VALUE_SHIPPED { get; set; }
        public Nullable<decimal> VOLUME_SHIPPED { get; set; }
